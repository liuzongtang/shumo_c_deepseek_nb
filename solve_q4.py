...
def main():
    ...
    out.append("")
    # 对比：若仍用附件1每日同价(问题2/3原结果) vs 附件4
    out.append("对比(问题2鲁棒): 附件1同价总费 14647581.90 元 vs 附件4波动价总费 %.2f 元" % t2)
    out.append("对比(问题3滚动): 附件1同价总费 14493184.73 元 vs 附件4波动价总费 %.2f 元" % t3)
    out.append("")
    # 跨日储能电量利用率
    Esoc = rob['E']
